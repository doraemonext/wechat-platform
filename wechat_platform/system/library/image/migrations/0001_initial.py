    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_id', models.CharField(max_length=50, null=True, verbose_name='\u56fe\u7247\u7684\u5a92\u4f53ID', blank=True)),
                ('image', models.ForeignKey(related_name=b'+', verbose_name='\u56fe\u7247\u6587\u4ef6', blank=True, to='media.Media', null=True)),
                ('official_account', models.ForeignKey(verbose_name='\u6240\u5c5e\u516c\u4f17\u53f7', to='official_account.OfficialAccount')),
            ],
            options={
                'db_table': 'library_image',
                'verbose_name': '\u7d20\u6750\u5e93 - \u56fe\u7247\u5e93',
                'verbose_name_plural': '\u7d20\u6750\u5e93 - \u56fe\u7247\u5e93',
            },
            bases=(models.Model,),
        ),
    ]
