    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=15, verbose_name='\u4fe1\u606f\u7c7b\u578b', choices=[(b'text', '\u6587\u672c\u6d88\u606f'), (b'image', '\u56fe\u7247\u6d88\u606f'), (b'video', '\u89c6\u9891\u6d88\u606f'), (b'link', '\u94fe\u63a5\u6d88\u606f'), (b'location', '\u5730\u7406\u4f4d\u7f6e\u6d88\u606f'), (b'event', '\u4e8b\u4ef6\u6d88\u606f'), (b'voice', '\u8bed\u97f3\u6d88\u606f')])),
                ...
                ('event_type', models.CharField(blank=True, max_length=15, null=True, verbose_name='\u4e8b\u4ef6\u7c7b\u578b', choices=[(b'subscribe', '\u8ba2\u9605\u4e8b\u4ef6'), (b'unsubscribe', '\u53d6\u6d88\u8ba2\u9605\u4e8b\u4ef6'), (b'click', '\u70b9\u51fb\u4e8b\u4ef6'), (b'location', '\u5730\u7406\u4f4d\u7f6e\u4e8b\u4ef6')])),
                ('event_key', models.TextField(null=True, verbose_name='\u4e8b\u4ef6key\u503c', blank=True)),
                ('event_latitude', models.FloatField(null=True, verbose_name='\u5730\u7406\u4f4d\u7f6e\u4e8b\u4ef6-\u7eac\u5ea6', blank=True)),
                ('event_longitude', models.FloatField(null=True, verbose_name='\u5730\u7406\u4f4d\u7f6e\u4e8b\u4ef6-\u7ecf\u5ea6', blank=True)),
                ('event_precision', models.FloatField(null=True, verbose_name='\u5730\u7406\u4f4d\u7f6e\u4e8b\u4ef6-\u7cbe\u5ea6', blank=True)),
            ...
            options={
                ...
                'verbose_name': '\u5fae\u4fe1\u670d\u52a1\u5668\u8bf7\u6c42',
                'verbose_name_plural': '\u5fae\u4fe1\u670d\u52a1\u5668\u8bf7\u6c42',
            },
            bases=(models.Model,),
        ),
    ]
